...
int main()
{
        ...
        while(1) {
                ...
                printf("        5. Ma hoa va luu xau dung ma DES.\n");
                printf("        6. Ma hoa va luu xau dung ma AES.\n");
		printf("        7. Doc va giai ma xau ma dung ma dich chuyen.\n");
		printf("        8. Doc va giai ma xau ma dung ma dung ma thay the.\n");
		printf("        9. Doc va giai ma xau ma dung ma dung ma hoan vi.\n");
		printf("        10. Doc va giai ma xau ma dung ma dung ma AES.\n");
		printf("        11. Doc va giai ma xau ma dung ma dung ma AES.\n");
                printf("        12. Exit.\n");
                printf("*************************************************\n");
                scanf(" %c", &option);
